...
class CoreOps:
    ...
    def neighbor_mode_update(
        ...
        # Delegate to GraphOps
        return self.builder.graph_ops.neighbor_mode_update(target, include_self, tie_break, ordered)
    ...
    def pow(self, base: Union[VarHandle, float], exponent: Union[VarHandle, float]) -> VarHandle:
        """
    ...
    def min(self, left: Union[VarHandle, float], right: Union[VarHandle, float]) -> VarHandle:
        """
    ...
    def max(self, left: Union[VarHandle, float], right: Union[VarHandle, float]) -> VarHandle:
        """

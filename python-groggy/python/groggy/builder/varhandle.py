...
class VarHandle:
    ...
    def __or__(self, other: 'VarHandle') -> 'VarHandle':
        ...
        raise NotImplementedError("Logical OR not yet implemented (requires max operator)")
    ...
    # Fluent methods
    def where(self, if_true: Union['VarHandle', float], 
              if_false: Union['VarHandle', float] = 0.0) -> 'VarHandle':
        """

    ...
    def _validate(self) -> tuple[list[str], list[str]]:
        ...
        for i, step in enumerate(self._steps):
            ...
            if "output" in step:
                ...
                if output_var in defined_vars and step_type not in in_place_steps and not is_iteration_output:
                    warnings.append(
            ...
            if "target" in step:
                ...
                if target_var in defined_vars and step_type not in in_place_steps and step_type != "alias":
                    warnings.append(

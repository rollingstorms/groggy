...
use crate::core::display::{DataWindow, DataType, DisplayConfig, TruncationStrategy};
...
impl CompactFormatter {
    ...
    fn render_data_row(
        ...
        row: &[String],
        widths: &[usize],
        schema: &crate::core::display::DataSchema,
        config: &DisplayConfig,
    ) -> String {
...
mod tests {
    use super::*;
    use crate::core::display::{DataWindow, DataSchema, ColumnSchema, DataType, DisplayConfig};

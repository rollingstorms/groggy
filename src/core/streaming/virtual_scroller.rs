...
impl VirtualScrollManager {
    ...
    pub fn get_visible_window(&self, data_source: &dyn DataSource) -> VirtualScrollResult<DataWindow> {
    ...
    pub fn handle_scroll(&mut self, new_offset: usize, data_source: &dyn DataSource) -> VirtualScrollResult<UpdateResult> {
    ...
    pub fn preload_buffer(&self, data_source: &dyn DataSource, center_offset: usize) -> VirtualScrollResult<()> {
